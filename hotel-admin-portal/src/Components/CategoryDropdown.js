...
const CategoryDropdown = ({ selectedValue, handleChangeCategory }) => {
    const [options, setOptions] = useState([
        ...
        { value: 'Paneer', label: 'Paneer' },
        { value: 'Non-Veg', label: 'Non-Veg' },
        { value: 'Dessert & Ice Cream', label: 'Dessert & Ice Cream' },
        { value: 'Hot Bevrages', label: 'Hot Bevrages' },
        { value: 'Cold Bevrages', label: 'Cold Bevrages' },
        ...
        { value: 'Paneer Starter', label: 'Paneer Starter' },
        { value: 'Tandoori Starter', label: 'Tandoori Starter' },
        { value: 'Chinese Starters', label: 'Chinese Starters' },
        { value: 'Soups', label: 'Soups' },
        { value: 'Parathas & Snacks', label: 'Parathas & Snacks' },
        { value: 'Main Course', label: 'Main Course' },
        { value: 'Paneer Special', label: 'Paneer Special' },
